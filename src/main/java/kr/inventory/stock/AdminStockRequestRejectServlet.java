...
/**
 * 입출고 요청 Ajax 거절. 재고는 유지한다.
 */
@WebServlet("/admin/stock/request/reject")
public class AdminStockRequestRejectServlet extends HttpServlet {
  @Override
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    int result = new StockService().rejectRequest(requestNo, login.getMemberId());
